                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {REPORT_REASONS.map((r) => (
                    <button
                      ...
                      style={{ padding: '12px 16px', background: reason === r ? 'rgba(0,102,255,0.1)' : 'var(--color-surface)', border: `1.5px solid ${reason === r ? 'var(--color-primary)' : 'var(--color-border)'}`, borderRadius: 12, cursor: 'pointer', textAlign: 'left', fontWeight: reason === r ? 600 : 400, color: 'var(--color-text-primary)', fontSize: 14 }}
                    >
                      {r}
                    </button>
                  ))}
